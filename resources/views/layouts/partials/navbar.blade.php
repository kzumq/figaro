...
<style>
    ...
    .nav_icon{font-size: 1.25rem}.show{left: 0}.body-pd{padding-left: calc(var(--nav-width) + 1rem)}
...
<!--
      @auth
        {{auth()->user()->name}}
        <div class="text-end">
          <a href="{{ route('logout.perform') }}" class=" text-right btn btn-dark me-2">Logout</a>
        </div>
      @endauth
